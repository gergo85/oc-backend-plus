        ...
        return [
            ...
            'category' => [
                ...
                'options'           => [
                    ...
                    'business'  => Lang::get('indikator.backend::lang.category.business'),
                    'cats'      => Lang::get('indikator.backend::lang.category.cats'),
                    'city'      => Lang::get('indikator.backend::lang.category.city'),
                    'food'      => Lang::get('indikator.backend::lang.category.food'),
                    'nightlife' => Lang::get('indikator.backend::lang.category.nightlife'),
                    'fashion'   => Lang::get('indikator.backend::lang.category.fashion'),
                    'people'    => Lang::get('indikator.backend::lang.category.people'),
                    'nature'    => Lang::get('indikator.backend::lang.category.nature'),
                    'sports'    => Lang::get('indikator.backend::lang.category.sports'),
                    'technics'  => Lang::get('indikator.backend::lang.category.technics'),
                    'transport' => Lang::get('indikator.backend::lang.category.transport')
                ]
            ],
            'type' => [
